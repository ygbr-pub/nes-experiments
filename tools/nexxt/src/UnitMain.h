...
public:		// User declarations
	...
	void __fastcall DrawExportTile16(TPicture*,int,int,int,int,bool);
	...
	void __fastcall SaveCHR(int offset,int size, bool fromSet);
    void __fastcall SaveTprop(int offset,int size);
	void __fastcall SetLatestCHR(int offset,int size, bool fromSet);
